function [D]=A2TC(alpha, A, B, beta, C, informat, outformat)
%
% A2TC  Compute GEMM with a model of a tensor core of the A2 GPU.
%
...
D = A100TC(alpha, A, B, C, beta, informat, outformat);